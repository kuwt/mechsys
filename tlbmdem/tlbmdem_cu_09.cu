...
public:
    ...
    double ParticleDistDelta  = 0.5*dx;
...
void LoadParameter(std::string jsonCFG_path) {  // should be rewritten into a template header
    ...
    getJsonPara( j2, "ParticleDistDelta", Parameter.ParticleDistDelta);
...
int main(int argc, char **argv) try
{
    ...
    dom.Solve(Tf,Tf/Parameter.OutputStep,Setup,Report,"tlbmdem_cu_09",true,Nproc);
}
MECHSYS_CATCH
